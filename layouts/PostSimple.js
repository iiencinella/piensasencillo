    ...
    <SectionContainer>
      ...
      <article>
        <div>
          ...
          <div
            className="divide-y dark:divide-gray-200 pb-8 divide-gray-700 xl:divide-y-0 "
            style={{ gridTemplateRows: 'auto 1fr' }}
          >
            <div className="divide-y dark:divide-gray-200 divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
